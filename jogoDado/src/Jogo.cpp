...
/**
* @brief Método mostra o resumo da rodad
*/
void Jogo::resumoRodada(){
	Jogador campeaoRodada;
	int maiorPontuacaorodada = 0;
	for(int i = 0; i < m_quantidadeJogadores; i++){
		/** @brief	Mostra o campeão da rodada*/
		...
		/** @brief	Verifica se o jogador foi eliminado*/
		if(m_jogadores[i].getEliminado() == 1)
			cout << "| ELIMINADO" << endl;
		else
			/** @brief	Verifica se o jogador parou na rodada*/
...
/**
* @brief Método para verificar se já há algum campeão.
* return 0 caso não tenho e 1 caso tenho um campeão
*/
...
/**
* @brief Método para printar o campeão do jogo
*/
