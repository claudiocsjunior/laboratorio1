...
public:
	...
	void FuncionalidadeListarFuncionarios(EmpresaConjunto &EmpresaConjunto, int empresaLogada); /**<Método para listar funcionários - chama o método da empresa*/
	void aumentarPorcentagemEmSalario(EmpresaConjunto &EmpresaConjunto, int empresaLogada); /**<Método para aumentar a porcentagem em salário - chama o método da empresa*/
	void listarFuncionariosEmExperiencia(EmpresaConjunto &EmpresaConjunto, int empresaLogada); /**<Método para listar os funcionários em eperiência - chama o método da empresa*/
};
